namespace NuclearResurrection.Utilities
{
	public static class Maths
	{
		...
		public static float Remap(this float _value, float _oldMin, float _oldMax, float _newMin, float _newMax) => _newMin + (_value - _oldMin) * (_newMax - _newMin) / (_oldMax - _oldMin);
	}
}