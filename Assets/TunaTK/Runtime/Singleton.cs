...
namespace TunaTK
{
	/// <summary>The base class for any singleton. This allows easy automated generation of singletons.</summary>
	...
	public class Singleton<T> : AssetBehaviour where T : Singleton<T>
	{
